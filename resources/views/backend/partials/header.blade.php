...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold nameUser m-0">Name</h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <!--begin::Header-->
        <div class="d-flex align-items-center mt-5" id="userInfoSideRight">
            ...
            <div class="d-flex flex-column userMailSideRight">
                ...
                <div class="text-muted mt-1">Level Name</div>
                <div class="navi mt-2">
                    <a href="javascript:void(0);" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary">sample@email.com</span>
                        </span>
                    </a>
                    <!-- <a href="javascript:void(0);" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Log Out</a> -->
                </div>
            </div>
        </div>
        <!--end::Header-->
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{ url('app_admin/user_profile') }}" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Lihat profil login anda</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
            <!--begin::Item-->
            <a href="{{ url('/') }}" target="_blank" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Publik</div>
                        <div class="text-muted">Lihat Halaman Publik</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
                    ...
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                            <span class="svg-icon svg-icon-md svg-icon-danger">
                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo7/dist/../src/media/svg/icons/Navigation/Sign-out.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
